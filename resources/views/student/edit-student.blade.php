                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select  @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin">
                                                ...
                                                <option value="Perempuan" {{ $studentEdit->jenis_kelamin == 'Perempuan' ? "selected" : ""}}>Perempuan</option>
                                                <option value="Laki-Laki" {{ $studentEdit->jenis_kelamin == 'Laki-Laki' ? "selected" : ""}}>Laki-Laki</option>
                                            </select>
                                            @error('jenis_kelamin')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('jurusan') is-invalid @enderror" name="jurusan">
                                                <option selected disabled>Pilih Jurusan</option>
                                                @foreach($jurusanList as $jurusan)
                                                    <option value="{{ $jurusan->nama_jurusan }}" {{ $studentEdit->jurusan == $jurusan->nama_jurusan ? 'selected' : '' }}>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control @error('admission_id') is-invalid @enderror" type="text" name="admission_id"
                                                value="{{ $studentEdit->admission_id }}">
                                            @error('admission_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
